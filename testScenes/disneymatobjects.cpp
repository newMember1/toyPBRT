...
//            auto rect = std::make_shared<rectangle>(glm::vec3(-0.2, -0.4, -1), glm::vec3(1, 0, 0), glm::vec3(0, 1, 0), 0.4, 0.4, goldMat);
//            rect->setRotate(glm::vec3(0, 1, 0), 10.0f);
//            rect->setTranslate(glm::vec3(
//                                   (j - 2) * 0.5f,
//                                   (i - 2) * 0.5f,
//                                   0.0f
//                                   ));
