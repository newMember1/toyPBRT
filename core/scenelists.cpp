#include "scenelists.h"

sceneLists::sceneLists(std::string)
{

}

sceneLists::sceneLists(std::unordered_map<std::string,std::shared_ptr<primitiveBase>> objects)
{
    this->objects.clear();
...
std::unique_ptr<primitiveList> & sceneLists::getLists()
{
    return this->worldList;
}

std::vector<std::vector<float>> sceneLists::getSceneFrameInfo()
{
...
void sceneLists::loadObjects(std::string path)
{

}

void sceneLists::loadTexture(std::string path)
{
...
void sceneLists::loadMatrials(std::string path)
{
